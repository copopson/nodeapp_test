...
class DryRunExecutor {
    ...
    async execute() {
        ...
        const { dryRunResult, timing } = await (0, rxjs_1.lastValueFrom)(testRunnerPool.schedule((0, rxjs_1.of)(0), (testRunner) => this.timeDryRun(testRunner)));
...
DryRunExecutor.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.injector, plugin_1.commonTokens.logger, plugin_1.commonTokens.options, di_1.coreTokens.timer, di_1.coreTokens.concurrencyTokenProvider, di_1.coreTokens.sandbox);
