...
const log4js_1 = (0, tslib_1.__importDefault)(require("log4js"));
...
class LogConfigurator {
    static createMainProcessAppenders(consoleLogLevel, fileLogLevel, allowConsoleColors) {
        ...
        const multiAppender = { type: require.resolve('./multi-appender'), appenders: ["filteredConsoleLevel" /* FilteredConsoleLevel */] };
    ...
    static configureMainProcess(consoleLogLevel = "info" /* Information */, fileLogLevel = "off" /* Off */, allowConsoleColors = true) {
        ...
        log4js_1.default.configure(this.createLog4jsConfig((0, log_utils_1.minLevel)(consoleLogLevel, fileLogLevel), appenders));
    }
    /**
    ...
    static async configureLoggingServer(consoleLogLevel, fileLogLevel, allowConsoleColors) {
        const loggerPort = await (0, net_utils_1.getFreePort)();
        ...
        const defaultLogLevel = (0, log_utils_1.minLevel)(consoleLogLevel, fileLogLevel);
        log4js_1.default.configure(this.createLog4jsConfig(defaultLogLevel, appenders));
        const context = {
            level: defaultLogLevel,
            port: loggerPort,
        };
    ...
    static configureChildProcess(context) {
        ...
        log4js_1.default.configure(this.createLog4jsConfig(context.level, appenders));
    }
    static shutdown() {
        return new Promise((res, rej) => {
            log4js_1.default.shutdown((err) => {
                if (err) {
                    rej(err);
                }
                else {
