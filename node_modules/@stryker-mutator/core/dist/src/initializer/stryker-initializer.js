...
exports.StrykerInitializer = void 0;
...
class StrykerInitializer {
    ...
    installNpmDependencies(dependencies, selectedOption) {
        ...
        this.out(cmd);
        try {
            child_process_1.default.execSync(cmd, { stdio: [0, 1, 2] });
        }
        catch (_) {
...
exports.StrykerInitializer = StrykerInitializer;
StrykerInitializer.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.logger, _1.initializerTokens.out, _1.initializerTokens.npmClient, _1.initializerTokens.strykerPresets, _1.initializerTokens.configWriter, _1.initializerTokens.gitignoreWriter, _1.initializerTokens.inquirer);
