...
exports.ClearTextScoreTable = void 0;
...
class ClearTextScoreTable {
    ...
    drawValues(current = this.metricsResult, ancestorCount = 0) {
        return [this.drawRow((c) => c.drawTableCell(current, ancestorCount))].concat((0, lodash_flatmap_1.default)(current.childResults, (child) => this.drawValues(child, ancestorCount + 1)));
    }
    /**
     * Returns a string with the score results drawn in a table.
     */
    draw() {
        return [this.drawBorder(), this.drawHeader(), this.drawBorder(), this.drawValues().join(os_1.default.EOL), this.drawBorder()].join(os_1.default.EOL);
    }
}
exports.ClearTextScoreTable = ClearTextScoreTable;
